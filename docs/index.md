...
!!! info "Note from the author"
    ...
    The 3D-printed panel design is still in early stages with no viable design yet. However, this isn't critical — I expect anyone using this project would solve the panel fabrication themselves.
